...
.die { position: absolute; width: 100%; height: 240px; }
.die:hover { background-color: #1d0619; }
-->
</style>
<!-- end stylesheets -->
...
<!--[if lte IE 6]><table><tr><td><![endif]-->
	...
	<li><a href="lines_horizontal.php" class="on" title="Lines (Horizontal)">Lines (Horizontal)</a></li>
...
for ($j=100; $j <= 500; $j=$j+100) {
		...
		//Background image
		echo 'background-image: url(images/lines.png)';
		echo '; ';
