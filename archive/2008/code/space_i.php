...
.die { position: absolute; width: 100%; height: 200px; }
...
<!--[if lte IE 6]><table><tr><td><![endif]-->
	<ul>
	<li><a href="space_i.php" class="on" title="Space I">Space I</a></li>
...
<?php
for ($j=80; $j <= 600; $j=$j+100) {
		//Top margin
		echo '<a href="space_ii.php"><div class="die" style="top: ' . $j . "px";
		echo '; ';
		
		//Background image
		echo 'background-image: url(images/plane_2.png)';
		echo '; ';
