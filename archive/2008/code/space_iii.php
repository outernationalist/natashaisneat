...
<!--[if lte IE 6]><table><tr><td><![endif]-->
	...
	<li><a href="space_iii.php" class="on" title="Space III">Space III</a></li>
...
for ($j=80; $j <= 600; $j=$j+100) {
		//Top margin
		echo '<a href="space_iv.php"><div class="die" style="top: ' . $j . "px";
		echo '; ';
		
		//Background image
		echo 'background-image: url(images/stands_5.png)';
		echo '; ';
