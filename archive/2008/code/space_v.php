...
div.a { width: 2%; height: 500px; margin: 0px auto; padding: 100px; float: left; background-image: url(images/plane_2.png)}
div.b { width: 100%; height: 500px; margin: 0px auto; padding: 100px; float: left; background-image: url(images/plane_2.png)}
div.c { width: 100%; height: 500px; margin: 0px auto; padding: 100px; float: left; background-image: url(images/plane_2.png)}
div.d { width: 100%; height: 500px; margin: 0px auto; padding: 100px; float: left; background-image: url(images/plane_2.png)}
div.e { width: 100%; height: 500px; margin: 0px auto; padding: 100px; float: right; background-image: url(images/plane_2.png)}
div.a:hover, div.b:hover, div.c:hover,  div.d:hover, div.e:hover { background-color: #c8c0ad;}
-->
</style>
<!-- end stylesheets -->
...
<!--[if lte IE 6]><table><tr><td><![endif]-->
    ...
    <li><a href="space_v.php" class="on" title="Space V">Space V</a></li>
...
<div class="a"><div class="b"><div class="c"><div class="d"><div class="e"></div></div></div></div></div>
<div class="a"><div class="b"><div class="c"><div class="d"><div class="e"></div></div></div></div></div>
<div class="a"><div class="b"><div class="c"><div class="d"><div class="e"></div></div></div></div></div>
<div class="a"><div class="b"><div class="c"><div class="d"><div class="e"></div></div></div></div></div>
<div class="a"><div class="b"><div class="c"><div class="d"><div class="e"></div></div></div></div></div>
